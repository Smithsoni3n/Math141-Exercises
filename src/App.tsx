 ...
 *
 * This version avoids Node-only APIs (`require`, `module.exports`) so it can be
 * copied into browser-based tools more easily.
 *
...
// (c) Largest possible area using the vertex of the quadratic
// A(W) = -2.5W^2 + 900W
...
function main() {
  ...
  console.log(`    Check fence usage: 2L + 5W = ${fenceConstraint(L, W)} ft`);
}
